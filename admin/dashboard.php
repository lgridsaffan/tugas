...
<head>
    ...
    <title>Admin | Tri Sukma</title> </head> <body>
            <!-- ============================================================== -->
            <!-- main wrapper -->
            <!-- ============================================================== -->
            <div class="dashboard-main-wrapper">
                ...
                <div class="dashboard-header">
                    <nav class="navbar navbar-expand-lg bg-white fixed-top">
                        <a class="navbar-brand" href="dashboard.php">Tri Sukma</a>
                        ...
                        <div class="container-fluid dashboard-content ">
                            ...
                            <div class="col-xl-12">
                                <div class="card">
                                    ...
                                    <div class="card-body">
                                        <p><b>Toko Buku Tri Sukma</b> merupakan aplikasi Toko Buku berbasis
                                            web. Di aplikasi ini, terdapat pembagian user/multi user yaitu
                                            Admin dan customer. Selain itu aplikasi ini terdiri
                                            dari menu Buku, Customer, Genre, Penerbit, Pengarang, User.
